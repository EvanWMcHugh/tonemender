...
export default function CheckEmailClient() {
  ...
  const canResendSignupConfirmation = type === "signup" && Boolean(email);
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-white px-6">
      <div className="w-full max-w-sm rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-lg sm:p-8">
