...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for ToneMender, the AI relationship and tone assistant.",
};
    ...
    <main className="bg-white">
      <div className="max-w-3xl mx-auto px-6 py-14 text-gray-800 leading-relaxed">
        ...
        <p>
          ...
          and safeguard information when you use ToneMender.
        </p>
        ...
        <p className="mt-4">
          Messages you submit are processed using artificial intelligence services, including OpenAI.
          We do not claim ownership of your content and do not sell personal data.
        </p>
        <p className="mt-4">
          If you choose to save drafts in the app, your messages and rewrites may be stored in your
          ToneMender account so you can view them later.
        </p>
        ...
        <p className="mt-4">
          Data is stored using Supabase infrastructure. While we implement reasonable safeguards, no
        ...
        <h2 className="text-xl font-semibold pt-8 border-t mt-8">6. Your Rights</h2>
        <p className="mt-4">
          You may access, update, or delete your account at any time directly within the app.
        </p>

        <h2 className="text-xl font-semibold pt-8 border-t mt-8">7. Contact</h2>
